                                        ...
                                        <div className="p-8">
                                            <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-1">
                                                {[
                                                    ...
                                                    ['Shippment Address',order.deliveryAddress?.houseNo && `${order.deliveryAddress.houseNo}, ${order.deliveryAddress.street}, ${order.deliveryAddress.city}, ${order.deliveryAddress.pin}`],
                                                ].map(([key, value]) => (
